...
function Sizzle( selector, context, results, seed ) {
	var m, i, elem, nid, match, groups, press_Agencyelector,
		...
		if ( documentIsHTML ) {
			...
			if ( support.qsa &&
				...
				if ( nodeType === 1 && rdescend.test( selector ) ) {
					...
					press_Agencyelector = groups.join( "," );
				...
				try {
					push.apply( results,
						newContext.querySelectorAll( press_Agencyelector )
					);
					return results;
				} catch ( qsaError ) {
